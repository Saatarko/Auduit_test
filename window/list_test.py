...
################################################################################
## Form generated from reading UI file 'list_test.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QRect(140, 30, 101, 41))
        font = QFont()
        font.setPointSize(12)
        self.label.setFont(font)
        self.list_test = QListWidget(Dialog)
        self.list_test.setObjectName(u"list_test")
        self.list_test.setGeometry(QRect(30, 80, 341, 192))
        self.btn_exit_to_menu = QPushButton(Dialog)
        self.btn_exit_to_menu.setObjectName(u"btn_exit_to_menu")
        self.btn_exit_to_menu.setGeometry(QRect(100, 290, 181, 24))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QCoreApplication.translate("Dialog", u"\u0421\u043f\u0438\u0441\u043e\u043a \u0442\u0435\u0441\u0442\u043e\u0432", None))
