...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.checkBox_answer_b.setGeometry(QRect(610, 500, 79, 20))
        self.btn_accept_answer = QPushButton(Dialog)
        self.btn_accept_answer.setObjectName(u"btn_accept_answer")
        self.btn_accept_answer.setGeometry(QRect(590, 540, 271, 51))
